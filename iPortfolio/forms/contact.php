...
if(empty($userName) || empty($userName) || empty($userSubject) || empty($userMessage)){
  echo 'Please Enter All the Fields';
}
else{
  $sql = "insert into user_details (name,email,subject,message) values ('$userName','$userEmail','$userSubject','$userMessage');";
  echo 'SuccessFully Submitted! We Will Contact ASAP.';
  $to = $userEmail;

  // Set up subject and message
  $subject = "Thank You for Reviewing My Portfolio";
  $message = "I hope this email finds you well. I wanted to express my gratitude for taking the time to review my portfolio. I truly appreciate the opportunity to share my work with you.<br>
  <br>
  <br>
  I am passionate about ['.$userMessage.'], and I believe my portfolio showcases my skills and dedication to this field. Each piece included represents not only my abilities but also my commitment to delivering high-quality work.<br>
  <br>
  <br>
  ...
  $headers = "From: kannankutty221@gmail.com\r\n";
...
//   <tr>
//   <td style="padding:25px 0" colspan="3"><h6 style="font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:18px;color:#666;font-weight:bold;margin:0;padding:0 0 20px 0">Dear '.$userName.',</h6>
...
//                           $mail_sent = true;
//                            echo 'Email sent to your registered mail id.';
//                            mysqli_query($conn,$sql);                
//                 }
//                 else
//                 {
